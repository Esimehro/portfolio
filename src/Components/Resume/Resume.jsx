...
const projects = [
  {
    ...
    description: 'amalaCloud is a dual-sided platform that simplifies financial decisions for users through product comparison and data control, while equipping businesses with secure, efficient data and identity management tools.',
    image: amalaCloud,
  ...
  },
  {
    ...
    description: 'The Cornie Health app is a patient-centric portal that simplifies access to healthcare. It empowers users to book appointments, manage prescriptions, access lab results, and connect with providers, all through a single, user-friendly platform. The app is part of a broader FHIR-based ecosystem designed to coordinate care and deliver a more efficient and personalized healthcare experience.',
    image: cornieHealth,
    liveLink: 'https://app.corniehealth.com/login?bookingsite=true&redirect=%2F&homepage=true',
    technologies: ['Vue,js', 'TypeScript', ' Pinia', 'Tailwind CSS' ]
  },
  {
    name: 'amalaCloud Service Provider App',
    description: 'A platform that equips service providers with essential tools to distribute financial products, and automated solutions for identity verification, address management, and data compliance.',
  ...
  },
   {
    ...
    description: 'amalaCloud empowers individuals with a central dashboard to compare financial products like loans and insurance, and to securely manage their personal data.',
    image: individual,
  ...
  },
   {
    ...
    description: 'Prioclen Technologies is a full-service software development and IT solutions company. They specialize in building custom web and mobile applications, providing managed cybersecurity services, and offering end-to-end IT infrastructure support (PIM) to help businesses scale and secure their operations.',
    image: ptech,
  ...
  },
  {
    ...
    description: 'JKBOFX is an educational website offering comprehensive forex trading resources. It provides a trading academy with expert-led courses, daily market signals, and automated trading tools (Expert Advisors) to equip both new and experienced traders with the knowledge and tools for success.',
    image: jkbofx,
  ...
  const bioDetails = [
    ...
    { id: 'programming-skills', label: 'Programming Skills', content: 'programming-skills' },
        ...
        <div className={styles.skillsContainer}>
          <div className={styles.skillCategory}>
            ...
            <div className={styles.skillsList}>
              {['JavaScript (ES6+)', 'TypeScript', 'C#', '.NET', 'React.js', 'Vue.js', 'SPFx'].map((skill, index) => (
          ...
          <div className={styles.skillCategory}>
            ...
            <div className={styles.skillsList}>
              {['React.js', 'Angular.js', 'Vue.js', 'SPFx', 'Next.js', 'Tailwind CSS', 'Bootstrap', 'WordPress'].map((skill, index) => (
                <span key={index} className={styles.skillTag}>
                  {skill}
                </span>
              ))}
          ...
          <div className={styles.skillCategory}>
            <h3 className={styles.skillCategoryTitle}>FRONTEND & UI DEVELOPMENT</h3>
            <div className={styles.skillsList}>
              {['Tailwind', 'CSS3', 'SASS', 'Redux Toolkit', 'Zustand', 'Figma', 'WordPress', 'Elementor', 'Bootstrap', 'MUI', 'React Query', 'Vuex', 'Pinia'].map((skill, index) => (
                <span key={index} className={styles.skillTag}>
                  {skill}
                </span>
              ))}
          ...
          <div className={styles.skillCategory}>
            <h3 className={styles.skillCategoryTitle}>DEVELOPMENT & DevOps</h3>
            <div className={styles.skillsList}>
              {['Azure', 'Google Cloud Platform (GCP)', 'CI/CD (Github Actions)', 'Git'].map((skill, index) => (
                <span key={index} className={styles.skillTag}>
                  {skill}
                </span>
              ))}
          ...
          <div className={styles.skillCategory}>
            ...
            <div className={styles.skillsList}>
              {['Attention to detail', 'Time management', 'Team player', 'Effective Communication', 'Problem-solving', 'Leadership', 'Client relationship management', 'Experience in using Microsoft 365'].map((skill, index) => (
                <span key={index} className={styles.skillTag}>
                  {skill}
                </span>
              ))}
            ...
            <div className={styles.bioSection}>
              ...
              <ul className={styles.bioList}>
                {bioDetails.map((item) => (
                  <li 
                    key={item.id} 
                    className={`${styles.bioItem} ${activeBio === item.id ? styles.bioItemActive : ''}`}
